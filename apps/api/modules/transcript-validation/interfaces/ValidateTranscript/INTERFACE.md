...
- PRP de reference : /docs/prp/PRP_ValidateTranscript.md
- Version du PRP : V1
...
## 3. Entrees attendues
- Champ: Transcript textuel complet
  - Type logique: texte
  - Obligatoire: Oui
  - Format/description: Transcript textuel complet
...
- Situation: Transcript non valide.
