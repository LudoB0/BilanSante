...
|---------|----------------------|
| Aucun point de vigilance mentionne. | Signalement explicite sans extrapolation |
...
Apres execution :
- La section 'Points de vigilance identifies' est produite et prete pour assemblage dans le bilan.
