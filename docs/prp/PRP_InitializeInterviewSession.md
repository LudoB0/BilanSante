...
Creer une session unique liant questionnaire, entretien et generation du bilan.
...
|------|------|------------|-------------|
| Tranche dage du patient | valeur categorielle | Oui | Tranche dage du patient |
...
- Identifiant de session et metadonnees associees (dont date/heure de creation)
...
|---------|----------------------|
| Session non creee (ID absent) ou dupliquee. | Signalement explicite sans extrapolation |
