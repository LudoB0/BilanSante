...
- Reference PRD : PRD V1 PRD 4.2-4.3; PRD 5.1; PRD 6
- Version : V1
- Statut : draft
...
Synthetiser les reponses du questionnaire en respectant la hierarchie des sources.
...
|---------|----------------------|
| Contradiction questionnaire / transcript. | Signalement explicite sans extrapolation |
...
Apres execution :
- La section 'Synthese des reponses' est produite et prete pour assemblage dans le bilan.
- Le pharmacien pourra la relire lors de la validation finale.
