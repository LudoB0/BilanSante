...
## 0. Metadonnees
- Nom du skill : GeneratePreventionActions
- Reference PRD : PRD V1 PRD 4.3; PRD 5.2; PRD 6
- Version : V1
- Statut : draft
...
|---------|----------------------|
| Action non justifiable par le transcript. | Signalement explicite sans extrapolation |
...
Apres execution :
- Le plan d'actions est produit avec justification et tracabilite.
- Le pharmacien pourra le relire lors de la validation finale.
