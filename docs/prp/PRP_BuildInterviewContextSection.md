...
## 0. Metadonnees
- Nom du skill : BuildInterviewContextSection
...
Produire la section  Contexte de lentretien .
...
- Section  Contexte de lentretien  du bilan
...
|---------|----------------------|
| Informations contextuelles non exprimees. | Signalement explicite sans extrapolation |
...
Apres execution :
- La section 'Contexte de l'entretien' est produite et prete pour assemblage dans le bilan.
