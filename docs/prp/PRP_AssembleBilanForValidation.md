...
## 0. Metadonnees
- Nom du skill : AssembleBilanForValidation
- Reference PRD : PRD V1 PRD 4.2-4.5; PRD 5.1-5.2; PRD 6
- Version : V1
- Statut : draft
...
|------|------|------------|-------------|
| Transcript valide | texte | Oui | Transcript valide |
| Reponses questionnaire | donnees structurees | Oui | Reponses questionnaire |
| Metadonnees de session et dentretien (ID, dates, duree, mode de recueil) | date-heure | Oui | Metadonnees de session et dentretien (ID, dates, duree, mode de recueil) |
...
|---------|----------------------|
| Sections incompletes faute dinformations exprimees. | Signalement explicite sans extrapolation |
